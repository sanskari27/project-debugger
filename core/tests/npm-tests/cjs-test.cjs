...
const { init } = require('../../dist/cjs/index.js');
...
// Test 6: Test destructuring import
console.log('\nTest 6: Destructuring import');
const testModule = require('../../dist/cjs/index.js');
if (typeof testModule.init === 'function') {
    console.log('✅ Destructuring import works correctly');
} else {
    console.log('❌ Destructuring import failed');
    process.exit(1);
}

// Test 7: Test module.exports structure
console.log('\nTest 7: Module exports structure');
const moduleExports = Object.keys(testModule);
if (moduleExports.includes('init')) {
    console.log('✅ Module exports contain init function');
} else {
    console.log('❌ Module exports missing init function');
    console.log('Available exports:', moduleExports);
    process.exit(1);
}
